...
from Bio.src.home import HomeScreen
...
class TSPApp(QWidget):
    def __init__(self):
        ...
        self.algorithm_selector.addItems(
            ["Ant Colony Optimization (ACO)", "Particle Swarm Optimization (PSO)", "DABC_FNS(GBC)",
    ...
    def run_algorithm(self):
        ...
        if "ACO" in algorithm:
            ...
            best_solution, best_cost = ant_colony_optimization(
                cost_matrix, alpha, beta, initial_pheromone, evaporation_rate, num_ants, deposit_constant,
                max_iterations
            )
